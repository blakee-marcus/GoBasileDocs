        ...
        <header className="space-y-3 border-b border-border pb-6">
          ...
          <div className="space-y-2">
            ...
            <p className="max-w-2xl text-sm text-muted-foreground">
              Typography defines GoBasile’s visual voice. It should feel structured, technical, and intentional,
              like engraved labeling on a precision tool.
            </p>
          </div>
        </header>
        ...
        <section className="grid gap-6 md:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)]">
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Typography should reinforce clarity and hierarchy. Consistent sizing, spacing, and weight make the
              interface feel engineered rather than improvised.
            </p>
          </div>
  ...
  'Helvetica Neue', Arial, 'Noto Sans', sans-serif;`}
          ...
          <div className="rounded-xl border border-border bg-card p-4 text-sm text-muted-foreground">
            ...
            <ul className="space-y-1 text-xs">
              ...
              <li>
                • <span className="font-medium text-foreground">500</span> - Buttons and input labels
              </li>
              <li>
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground">Use predictable sizing and structure to guide attention.</p>
            ...
            <table className="w-full border-collapse text-xs">
              ...
              <tbody>
                ...
                <tr className="border-b border-border/60">
                  ...
                  <td className="py-2 pr-4 text-muted-foreground">Major subheadings in panels or modals</td>
                </tr>
                <tr className="border-b border-border/60">
                ...
                <tr className="border-b border-border/60">
                  ...
                  <td className="py-2 text-muted-foreground">text-sm font-normal leading-relaxed</td>
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground">Use consistent vertical rhythm for readability.</p>
  ...
  <p className='text-sm text-muted-foreground leading-relaxed'>
    Manage specifications and conditions for each listed device.
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground">
            Left-align text by default. Align headings and labels directly above or beside their content.
          </p>
...
<p className='text-xs text-muted-foreground'>
  Secondary description or timestamp
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground">
            Text should feel practical, direct, and confident. Avoid marketing language or overly playful copy.
          </p>
...
<select className='mt-1 w-full rounded-md border border-border px-3 py-2 text-sm'>
  ...
  <option>Laptop</option>
            ...
            <table className="w-full border-collapse text-xs">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="py-2 pr-4 text-muted-foreground">
                    Use sentence case for labels and headings, with uppercase reserved for small meta labels only.
                  </td>
                </tr>
              </tbody>
            </table>
        ...
        <section className="space-y-3">
          ...
          <p className="max-w-2xl text-sm text-muted-foreground">
            Typography is the backbone of GoBasile’s utilitarian aesthetic. Applied consistently, it communicates
            craftsmanship, reliability, and focus, and makes every screen feel like part of the same engineered
            system.
          </p>
        </section>
      </div>
